...
const SITE_URL = "https://rambla.sh";

const PRODUCT_PREAMBLE = `# Rambla
...
Rambla is an open source application that lets you run AI coding agents on your own machine and drive them from your phone, desktop, browser, or terminal. Your code stays local — Rambla connects directly to your real development environment instead of running agents in someone else's cloud.
...
- [Changelog](${SITE_URL}/changelog): Release notes for the Rambla daemon, CLI, desktop, and mobile apps.
- [Download](${SITE_URL}/download): Install Rambla on Mac, Windows, Linux, iOS, Android, or run the web app.
- [Rambla Hub](${SITE_URL}/hub): Connect daemons and run GitHub, Slack, Discord, and Linear workflows through the hosted service or your own deployment.
