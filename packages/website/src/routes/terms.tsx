  ...
  return (
    <LegalPage title="Terms of Service" lastUpdated="August 29, 2026">
      ...
      <section>
        <h2>Governing law</h2>
        <p>
          These Terms are governed by U.S. and International law. If you are a consumer, you keep
          the mandatory protections and court rights provided by the law where you live.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          <a href="mailto:tom@dra11y.com">tom@dra11y.com</a>.
        </p>
      </section>
    </LegalPage>
  );
