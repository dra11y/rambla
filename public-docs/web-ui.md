...
Paseo's daemon can serve the browser web app itself, from the same address it already uses for the API. You don't need the hosted app at [app.rambla.sh](https://app.rambla.sh): point a browser at your own daemon and you get the full UI, connected to your own agents, on infrastructure you control.
...
For the full threat model, relay encryption, and DNS-rebinding details, see [Security](/docs/security) and [SECURITY.md](https://github.com/getrambla/rambla/blob/main/SECURITY.md).
